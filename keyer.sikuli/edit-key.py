from sikuli import *
def editKey():
    newKey = "ABF000F5-BF68-C631-E040-18C3EA454DAA"
    click("1376472023054.png")
    wait(Pattern("YCTGHOBHCHGI.png").similar(0.50),30)
    type(Pattern("nO1Tb3OBBT1T-1.png").targetOffset(-63,-1), newKey)
    type(Pattern("ap0m-1.png").targetOffset(-60,-3), "wwqwqwq")
...
#    doubleClick(Pattern("3Dhttpservic.png").targetOffset(22,6))
#    paste("http://services.navstat.infokinetika.net")
    click("OK-2.png")
    wait(Pattern("YCTGHOBHCHGI.png").similar(0.50),30)
    click("Onaena.png")
    print "curent key -------"
